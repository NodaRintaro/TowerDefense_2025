...
public class SupportCardSelectController : MonoBehaviour
{
    ...
    private ScreenManager _screenChanger;
    ...
    private TrainingSaveDataManager _trainingCharacterSaveDataManager;
    ...
    public async void Start()
    {
        ...
        _screenChanger = _trainingDataSelectLifeTimeScope.Container.Resolve<ScreenManager>();
        ...
        _trainingCharacterSaveDataManager = _trainingDataSelectLifeTimeScope.Container.Resolve<TrainingSaveDataManager>();
