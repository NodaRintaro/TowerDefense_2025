...
public class ParameterEventBonusView : MonoBehaviour
{
    ...
    private RaisingSimulationDataContainer _raisingSimulationLifeTimeScope = null;
    ...
    public void Awake()
    {
        _raisingSimulationLifeTimeScope = FindFirstObjectByType<RaisingSimulationDataContainer>();
