...
[System.Serializable]
public class CharacterPickUIHolder : IView
{
    ...
    private StatusText[] _characterStatusTexts = default;

    [SerializeField, Header("characterのステータスのスライダー")]
    private StatusSlider[] _characterStatusSliders = default;
    ...
    public StatusText[] CharacterStatusTexts => _characterStatusTexts;
    ...
    public void SetStatusText(StatusType statusType, string text)
    {
