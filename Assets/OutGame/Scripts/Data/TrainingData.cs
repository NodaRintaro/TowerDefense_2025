...
namespace TrainingData
{
    ...
    public class TrainingDataHolder
    {
        ...
        private CardData[] _selectedSupportCardData = null;

        public TrainingCharacterData TrainingCharacterData => _trainingCharacterData;
        public CardData[] SelectedSupportCards => _selectedSupportCardData;
        ...
        public void SetSupportCardsData(CardData[] supportCardDatas)
        {
    ...
    public class TrainingCharacterData : CharacterBaseData
    {
        ...
        private Dictionary<ParameterType, RankSpriteData> _parameterRankDict = new();
        ...
        public Dictionary<ParameterType, RankSpriteData> ParameterRankDict => _parameterRankDict;
