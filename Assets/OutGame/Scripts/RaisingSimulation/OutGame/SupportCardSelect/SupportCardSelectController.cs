...
public class SupportCardSelectController : MonoBehaviour
{
    ...
    private const string _trainingsSaveDataName = "TrainingData";

    private TrainingDataHolder _trainingDataHolder;
    private ScreenChanger _screenChanger;
    private CharacterSelectMenuController _characterPickController;
    private RaisingSimulationOutGameLifeTimeScope _trainingDataSelectLifeTimeScope;

    public SupportCardSelectUIHolder SupportCardSelectUIHolder => _supportCardSelectUIHolder;

    public async void Start()
    {
        _trainingDataSelectLifeTimeScope = FindAnyObjectByType<RaisingSimulationOutGameLifeTimeScope>();
        _characterPickController = _trainingDataSelectLifeTimeScope.Container.Resolve<CharacterSelectMenuController>();
        ...
        _screenChanger = _trainingDataSelectLifeTimeScope.Container.Resolve<ScreenChanger>();
    ...
    private void OnClickStartRaisingSimulation()
    {
        ...
        DataSaveSystem.DataSave(_trainingDataHolder, _trainingsSaveDataName);
        SceneChanger.SceneChange(_raisingSimulationSceneName);
    }
