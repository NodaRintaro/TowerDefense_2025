...
public class CharacterSelectScreenChanger
{
    private CharacterPickController _characterPickController;
    private SupportCardSelectController _supportCardSelectController;

    [Inject]
    public CharacterSelectScreenChanger(CharacterPickController characterPickController, SupportCardSelectController supportCardSelectController)
    {
